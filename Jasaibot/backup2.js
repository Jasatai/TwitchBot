...
var cmds = ['!commands', 'cmd', '!dice', '!die', '!easteregg', '!bot info', 'ara ara', 'moin', 'gn8', '!naughty', '!dev', 'time', '!lurk', '!bye', '!duschAdventure', '!dev messages', '!discord', '!dc', '!swimsuits', '!devlog', '!raid', '!test', '!modAbuse'];
...
function onMessageHandler (target, context, msg, self) {
  ...
  */
  ...
  } else if (cmw[0] === cmds[22]) {
    client.say(target, 'hör auf meine ganzen nachichten zu löschen @luzi🤬')
  } else {
    validCmd = false;
  } 
